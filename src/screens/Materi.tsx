...
export default function Materi({navigation}: {navigation: any}) {
  ...
  const dataImage = [
    {id: 1, imageURL: require('../assets/img/materi/1.jpg')},
    {id: 2, imageURL: require('../assets/img/materi/2.png')},
    {id: 3, imageURL: require('../assets/img/materi/3.png')},
    {id: 4, imageURL: require('../assets/img/materi/4.jpg')},
    ...
    {id: 11, imageURL: require('../assets/img/materi/11.jpg')},
    ...
    {id: 15, imageURL: require('../assets/img/materi/15.jpg')},
    {id: 16, imageURL: require('../assets/img/materi/16.jpg')},
    {id: 17, imageURL: require('../assets/img/materi/17.jpg')},
